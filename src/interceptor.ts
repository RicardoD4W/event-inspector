/**
 * Event Interceptor - Hooks EventTarget.prototype.dispatchEvent to capture CustomEvents
 */
 ...
 */
export function initInterceptor(callback: (event: CustomEvent, target: EventTarget) => void): void {
